...
<#--空格列-->
<#if deep gt 0>
<img src="${base}/common/res/img/tree/s.gif" width="15px" /><#t/>
</#if>
<#--直线列-->
<#if deep gt 1>
	<#list 2..deep as i>
		<#if isEndList[i-1]>
			<img src="${base}/common/res/img/tree/s.gif" width="15px" /><#t/>
		<#else>
			<img src="${base}/common/res/img/tree/elbow-line.gif" /><#t/>
		</#if>
	</#list>
</#if>
<#--节点列-->
...
<#if isLeaf && isEndList[deep]>
	<img src="${base}/common/res/img/tree/elbow-end.gif" /><img src="${base}/common/res/img/tree/leaf.gif" /><#t/>
<#elseif isLeaf && !isEndList[deep]>
	<img src="${base}/common/res/img/tree/elbow.gif" /><img src="${base}/common/res/img/tree/leaf.gif" /><#t/>
<#elseif !isLeaf && isEndList[deep]>
	<img id="${id}-co" src="${base}/common/res/img/tree/elbow-end-minus.gif" onclick="Pn.Tree.switchDisplay('${id}')" style="cursor:pointer;${openDisplay}"/><#t/>
	<img id="${id}-cc" src="${base}/common/res/img/tree/elbow-end-plus.gif" onclick="Pn.Tree.switchDisplay('${id}')" style="cursor:pointer;${closeDisplay}"/><#t/>
	<img id="${id}-fo" src="${base}/common/res/img/tree/folder-open.gif" style="${openDisplay}"/><#t/>
	<img id="${id}-fc" src="${base}/common/res/img/tree/folder.gif" style="${closeDisplay}"/><#t/>
<#elseif !isLeaf && !isEndList[deep]>
	<img id="${id}-co" src="${base}/common/res/img/tree/elbow-minus.gif" onclick="Pn.Tree.switchDisplay('${id}')" style="cursor:pointer;${openDisplay}"/><#t/>
	<img id="${id}-cc" src="${base}/common/res/img/tree/elbow-plus.gif" onclick="Pn.Tree.switchDisplay('${id}')" style="cursor:pointer;${closeDisplay}"/><#t/>
	<img id="${id}-fo" src="${base}/common/res/img/tree/folder-open.gif" style="${openDisplay}"/><#t/>
	<img id="${id}-fc" src="${base}/common/res/img/tree/folder.gif" style="${closeDisplay}"/><#t/>
</#if>
<#if isCheckBox>
