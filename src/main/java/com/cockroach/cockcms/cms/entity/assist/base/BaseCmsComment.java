...
public abstract class BaseCmsComment  implements Serializable {
	...
	// one to one
	private com.cockroach.cockcms.cms.entity.assist.CmsCommentExt commentExt;

	// many to one
	private com.cockroach.cockcms.core.entity.CmsUser replayUser;
	private com.cockroach.cockcms.cms.entity.main.Content content;
	private com.cockroach.cockcms.core.entity.CmsUser commentUser;
	 ...
	 */
	public com.cockroach.cockcms.cms.entity.assist.CmsCommentExt getCommentExt () {
		return commentExt;
	}
	 ...
	 */
	public void setCommentExt (com.cockroach.cockcms.cms.entity.assist.CmsCommentExt commentExt) {
	 ...
	 */
	public com.cockroach.cockcms.core.entity.CmsUser getReplayUser () {
		return replayUser;
	}
	 ...
	 */
	public void setReplayUser (com.cockroach.cockcms.core.entity.CmsUser replayUser) {
	 ...
	 */
	public com.cockroach.cockcms.cms.entity.main.Content getContent () {
		return content;
	}
	 ...
	 */
	public void setContent (com.cockroach.cockcms.cms.entity.main.Content content) {
	 ...
	 */
	public com.cockroach.cockcms.core.entity.CmsUser getCommentUser () {
		return commentUser;
	}
	 ...
	 */
	public void setCommentUser (com.cockroach.cockcms.core.entity.CmsUser commentUser) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.cms.entity.assist.CmsComment)) return false;
		else {
			com.cockroach.cockcms.cms.entity.assist.CmsComment cmsComment = (com.cockroach.cockcms.cms.entity.assist.CmsComment) obj;
