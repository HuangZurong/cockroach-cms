...
public abstract class BaseCmsSiteAccessStatistic  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.cms.entity.assist.CmsSiteAccessStatistic)) return false;
		else {
			com.cockroach.cockcms.cms.entity.assist.CmsSiteAccessStatistic cmsSiteAccessStatistic = (com.cockroach.cockcms.cms.entity.assist.CmsSiteAccessStatistic) obj;
