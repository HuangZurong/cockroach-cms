...
import static com.cockroach.cockcms.common.web.Constants.INDEX;
...
import com.cockroach.cockcms.cms.entity.main.base.BaseChannel;
import com.cockroach.cockcms.cms.staticpage.StaticPageUtils;
import com.cockroach.cockcms.common.hibernate3.HibernateTree;
import com.cockroach.cockcms.common.hibernate3.PriorityComparator;
import com.cockroach.cockcms.common.hibernate3.PriorityInterface;
...
//			return getUrlDynamic(null);
	...
	public Channel(Integer id,
			...
			com.cockroach.cockcms.cms.entity.main.CmsModel model, Integer lft,
