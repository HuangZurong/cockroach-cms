...
public abstract class BaseCmsTopic  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.cms.entity.main.CmsTopic)) return false;
		else {
			com.cockroach.cockcms.cms.entity.main.CmsTopic cmsTopic = (com.cockroach.cockcms.cms.entity.main.CmsTopic) obj;
