...
public abstract class BaseCmsSiteFlow  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.cms.entity.assist.CmsSiteFlow)) return false;
		else {
			com.cockroach.cockcms.cms.entity.assist.CmsSiteFlow cmsSiteFlow = (com.cockroach.cockcms.cms.entity.assist.CmsSiteFlow) obj;
