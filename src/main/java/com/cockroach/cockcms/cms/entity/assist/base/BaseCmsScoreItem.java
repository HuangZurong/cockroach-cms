...
public abstract class BaseCmsScoreItem  implements Serializable {
	...
	public BaseCmsScoreItem (
		Integer id,
		com.cockroach.cockcms.cms.entity.assist.CmsScoreGroup group,
		String name,
		Integer score,
		Integer priority) {
	...
	// many to one
	private com.cockroach.cockcms.cms.entity.assist.CmsScoreGroup group;

	// collections
	private java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsScoreRecord> records;
	 ...
	 */
	public com.cockroach.cockcms.cms.entity.assist.CmsScoreGroup getGroup () {
		return group;
	}
	 ...
	 */
	public void setGroup (com.cockroach.cockcms.cms.entity.assist.CmsScoreGroup group) {
		this.group = group;
	}
	 ...
	 */
	public java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsScoreRecord> getRecords () {
		return records;
	}
	 ...
	 */
	public void setRecords (java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsScoreRecord> records) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.cms.entity.assist.CmsScoreItem)) return false;
		else {
			com.cockroach.cockcms.cms.entity.assist.CmsScoreItem cmsScoreItem = (com.cockroach.cockcms.cms.entity.assist.CmsScoreItem) obj;
