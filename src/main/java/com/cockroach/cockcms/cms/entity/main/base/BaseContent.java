...
public abstract class BaseContent  implements Serializable {
	...
	// one to one
	private com.cockroach.cockcms.cms.entity.main.ContentExt contentExt;
	private com.cockroach.cockcms.cms.entity.main.ContentCount contentCount;

	// many to one
	private com.cockroach.cockcms.cms.entity.main.ContentType type;
	...
	private com.cockroach.cockcms.cms.entity.main.CmsModel model;

	// collections
	private java.util.Set<com.cockroach.cockcms.cms.entity.main.Channel> channels;
	private java.util.Set<com.cockroach.cockcms.cms.entity.main.CmsTopic> topics;
	private java.util.Set<com.cockroach.cockcms.core.entity.CmsGroup> viewGroups;
	private java.util.List<com.cockroach.cockcms.cms.entity.main.ContentTag> tags;
	private java.util.List<com.cockroach.cockcms.cms.entity.main.ContentPicture> pictures;
	private java.util.List<com.cockroach.cockcms.cms.entity.main.ContentAttachment> attachments;
	private java.util.Set<com.cockroach.cockcms.cms.entity.main.ContentTxt> contentTxtSet;
	private java.util.Set<com.cockroach.cockcms.cms.entity.main.ContentCheck> contentCheckSet;
	private java.util.Map<String, String> attr;
	private java.util.Set<com.cockroach.cockcms.core.entity.CmsUser> collectUsers;
	private java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsComment> comments;
	private java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsFile> files;
	private java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsJobApply> jobApplys;
	private java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsScoreRecord> scoreRecordSet;
	...
	public java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsFile> getFiles() {
		return files;
	}

	public void setFiles(java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsFile> files) {
		this.files = files;
	}
	
	public java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsJobApply> getJobApplys() {
			return jobApplys;
	}
	
	public void setJobApplys(
				java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsJobApply> jobApplys) {
	...
	public java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsScoreRecord> getScoreRecordSet() {
		return scoreRecordSet;
	}

	public void setScoreRecordSet(
			java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsScoreRecord> scoreRecordSet) {
	 ...
	 */
	public com.cockroach.cockcms.cms.entity.main.ContentExt getContentExt () {
		return contentExt;
	}
	 ...
	 */
	public void setContentExt (com.cockroach.cockcms.cms.entity.main.ContentExt contentExt) {
	 ...
	 */
	public com.cockroach.cockcms.cms.entity.main.ContentCount getContentCount () {
		return contentCount;
	}
	 ...
	 */
	public void setContentCount (com.cockroach.cockcms.cms.entity.main.ContentCount contentCount) {
	 ...
	 */
	public com.cockroach.cockcms.cms.entity.main.ContentType getType () {
		return type;
	}
	 ...
	 */
	public void setType (com.cockroach.cockcms.cms.entity.main.ContentType type) {
		this.type = type;
	}
	...
	public com.cockroach.cockcms.cms.entity.main.CmsModel getModel() {
		return model;
	}

	public void setModel(com.cockroach.cockcms.cms.entity.main.CmsModel model) {
		this.model = model;
	}
	 ...
	 */
	public java.util.Set<com.cockroach.cockcms.cms.entity.main.Channel> getChannels () {
		return channels;
	}
	 ...
	 */
	public void setChannels (java.util.Set<com.cockroach.cockcms.cms.entity.main.Channel> channels) {
	 ...
	 */
	public java.util.Set<com.cockroach.cockcms.cms.entity.main.CmsTopic> getTopics () {
		return topics;
	}
	 ...
	 */
	public void setTopics (java.util.Set<com.cockroach.cockcms.cms.entity.main.CmsTopic> topics) {
		this.topics = topics;
	}
	 ...
	 */
	public java.util.Set<com.cockroach.cockcms.core.entity.CmsGroup> getViewGroups () {
		return viewGroups;
	}
	 ...
	 */
	public void setViewGroups (java.util.Set<com.cockroach.cockcms.core.entity.CmsGroup> viewGroups) {
	 ...
	 */
	public java.util.List<com.cockroach.cockcms.cms.entity.main.ContentTag> getTags () {
		return tags;
	}
	 ...
	 */
	public void setTags (java.util.List<com.cockroach.cockcms.cms.entity.main.ContentTag> tags) {
		this.tags = tags;
	}
	 ...
	 */
	public java.util.List<com.cockroach.cockcms.cms.entity.main.ContentPicture> getPictures () {
		return pictures;
	}
	 ...
	 */
	public void setPictures (java.util.List<com.cockroach.cockcms.cms.entity.main.ContentPicture> pictures) {
	 ...
	 */
	public java.util.List<com.cockroach.cockcms.cms.entity.main.ContentAttachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.List<com.cockroach.cockcms.cms.entity.main.ContentAttachment> attachments) {
	 ...
	 */
	public java.util.Set<com.cockroach.cockcms.cms.entity.main.ContentTxt> getContentTxtSet () {
	 ...
	 */
	public void setContentTxtSet (java.util.Set<com.cockroach.cockcms.cms.entity.main.ContentTxt> contentTxtSet) {
	 ...
	 */
	public java.util.Set<com.cockroach.cockcms.cms.entity.main.ContentCheck> getContentCheckSet () {
	 ...
	 */
	public void setContentCheckSet (java.util.Set<com.cockroach.cockcms.cms.entity.main.ContentCheck> contentCheckSet) {
	...
	public java.util.Set<com.cockroach.cockcms.core.entity.CmsUser> getCollectUsers() {
		return collectUsers;
	}

	public void setCollectUsers(
			java.util.Set<com.cockroach.cockcms.core.entity.CmsUser> collectUsers) {
		this.collectUsers = collectUsers;
	}
	

	public java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsComment> getComments() {
		return comments;
	}

	public void setComments(
			java.util.Set<com.cockroach.cockcms.cms.entity.assist.CmsComment> comments) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.cms.entity.main.Content)) return false;
		else {
			com.cockroach.cockcms.cms.entity.main.Content content = (com.cockroach.cockcms.cms.entity.main.Content) obj;
