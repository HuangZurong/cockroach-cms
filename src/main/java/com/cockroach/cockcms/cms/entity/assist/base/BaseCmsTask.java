...
public abstract class BaseCmsTask  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.cms.entity.assist.CmsTask)) return false;
		else {
			com.cockroach.cockcms.cms.entity.assist.CmsTask cmsTask = (com.cockroach.cockcms.cms.entity.assist.CmsTask) obj;
