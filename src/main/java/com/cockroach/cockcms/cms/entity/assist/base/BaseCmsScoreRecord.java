...
public abstract class BaseCmsScoreRecord  implements Serializable {
	...
	// many to one
	private com.cockroach.cockcms.cms.entity.assist.CmsScoreItem item;
	 ...
	 */
	public com.cockroach.cockcms.cms.entity.assist.CmsScoreItem getItem () {
		return item;
	}
	 ...
	 */
	public void setItem (com.cockroach.cockcms.cms.entity.assist.CmsScoreItem item) {
		this.item = item;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.cms.entity.assist.CmsScoreRecord)) return false;
		else {
			com.cockroach.cockcms.cms.entity.assist.CmsScoreRecord cmsScoreRecord = (com.cockroach.cockcms.cms.entity.assist.CmsScoreRecord) obj;
