...
public abstract class BaseCmsGuestbook  implements Serializable {
	...
	public BaseCmsGuestbook (
		...
		com.cockroach.cockcms.cms.entity.assist.CmsGuestbookCtg ctg,
		String ip,
	...
	// one to one
	private com.cockroach.cockcms.cms.entity.assist.CmsGuestbookExt ext;

	// many to one
	private com.cockroach.cockcms.core.entity.CmsUser member;
	private com.cockroach.cockcms.core.entity.CmsUser admin;
	private com.cockroach.cockcms.core.entity.CmsSite site;
	private com.cockroach.cockcms.cms.entity.assist.CmsGuestbookCtg ctg;
	 ...
	 */
	public com.cockroach.cockcms.cms.entity.assist.CmsGuestbookExt getExt () {
		return ext;
	}
	 ...
	 */
	public void setExt (com.cockroach.cockcms.cms.entity.assist.CmsGuestbookExt ext) {
		this.ext = ext;
	}
	 ...
	 */
	public com.cockroach.cockcms.core.entity.CmsUser getMember () {
		return member;
	}
	 ...
	 */
	public void setMember (com.cockroach.cockcms.core.entity.CmsUser member) {
		this.member = member;
	}
	 ...
	 */
	public com.cockroach.cockcms.core.entity.CmsUser getAdmin () {
		return admin;
	}
	 ...
	 */
	public void setAdmin (com.cockroach.cockcms.core.entity.CmsUser admin) {
		this.admin = admin;
	}
	 ...
	 */
	public com.cockroach.cockcms.cms.entity.assist.CmsGuestbookCtg getCtg () {
		return ctg;
	}
	 ...
	 */
	public void setCtg (com.cockroach.cockcms.cms.entity.assist.CmsGuestbookCtg ctg) {
		this.ctg = ctg;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.cms.entity.assist.CmsGuestbook)) return false;
		else {
			com.cockroach.cockcms.cms.entity.assist.CmsGuestbook cmsGuestbook = (com.cockroach.cockcms.cms.entity.assist.CmsGuestbook) obj;
