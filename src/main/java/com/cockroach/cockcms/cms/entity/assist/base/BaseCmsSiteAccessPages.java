...
public abstract class BaseCmsSiteAccessPages  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.cms.entity.assist.CmsSiteAccessPages)) return false;
		else {
			com.cockroach.cockcms.cms.entity.assist.CmsSiteAccessPages cmsSiteAccessPages = (com.cockroach.cockcms.cms.entity.assist.CmsSiteAccessPages) obj;
