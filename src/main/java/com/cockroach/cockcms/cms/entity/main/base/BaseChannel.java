...
public abstract class BaseChannel  implements Serializable {
	...
	public BaseChannel (
		...
		com.cockroach.cockcms.cms.entity.main.CmsModel model,
		Integer lft,
		Integer rgt,
		Integer priority,
		Boolean hasContent,
	...
	// one to one
	private com.cockroach.cockcms.cms.entity.main.ChannelExt channelExt;
	private com.cockroach.cockcms.cms.entity.main.ChannelCount channelCount;

	// many to one
	private com.cockroach.cockcms.core.entity.CmsSite site;
	private com.cockroach.cockcms.cms.entity.main.CmsModel model;
	private com.cockroach.cockcms.cms.entity.main.Channel parent;

	// collections
	private java.util.Set<com.cockroach.cockcms.cms.entity.main.Channel> child;
	private java.util.Set<com.cockroach.cockcms.core.entity.CmsGroup> viewGroups;
	private java.util.Set<com.cockroach.cockcms.core.entity.CmsGroup> contriGroups;
	private java.util.Set<com.cockroach.cockcms.core.entity.CmsUser> users;
	private java.util.Set<com.cockroach.cockcms.cms.entity.main.ChannelTxt> channelTxtSet;
	private java.util.List<com.cockroach.cockcms.cms.entity.main.ChannelModel> channelModels;
	 ...
	 */
	public com.cockroach.cockcms.cms.entity.main.ChannelExt getChannelExt () {
		return channelExt;
	}
	 ...
	 */
	public void setChannelExt (com.cockroach.cockcms.cms.entity.main.ChannelExt channelExt) {
		this.channelExt = channelExt;
	}
	
	public com.cockroach.cockcms.cms.entity.main.ChannelCount getChannelCount() {
		return channelCount;
	}

	public void setChannelCount(com.cockroach.cockcms.cms.entity.main.ChannelCount channelCount) {
	 ...
	 */
	public com.cockroach.cockcms.cms.entity.main.Channel getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.cockroach.cockcms.cms.entity.main.Channel parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.cockroach.cockcms.cms.entity.main.Channel> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.cockroach.cockcms.cms.entity.main.Channel> child) {
		this.child = child;
	}
	 ...
	 */
	public java.util.Set<com.cockroach.cockcms.core.entity.CmsGroup> getContriGroups () {
		return contriGroups;
	}
	 ...
	 */
	public void setContriGroups (java.util.Set<com.cockroach.cockcms.core.entity.CmsGroup> contriGroups) {
	 ...
	 */
	public java.util.Set<com.cockroach.cockcms.core.entity.CmsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.cockroach.cockcms.core.entity.CmsUser> users) {
		this.users = users;
	}
	/**
	 * Return the value associated with the column: channelTxtSet
	 */
	public java.util.Set<com.cockroach.cockcms.cms.entity.main.ChannelTxt> getChannelTxtSet () {
	 ...
	 */
	public void setChannelTxtSet (java.util.Set<com.cockroach.cockcms.cms.entity.main.ChannelTxt> channelTxtSet) {
		this.channelTxtSet = channelTxtSet;
	}

	public java.util.List<com.cockroach.cockcms.cms.entity.main.ChannelModel> getChannelModels() {
		return channelModels;
	}

	public void setChannelModels(
			java.util.List<com.cockroach.cockcms.cms.entity.main.ChannelModel> channelModels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.cms.entity.main.Channel)) return false;
		else {
			com.cockroach.cockcms.cms.entity.main.Channel channel = (com.cockroach.cockcms.cms.entity.main.Channel) obj;
