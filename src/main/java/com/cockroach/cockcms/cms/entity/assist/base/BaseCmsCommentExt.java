...
public abstract class BaseCmsCommentExt  implements Serializable {
	...
	// one to one
	private com.cockroach.cockcms.cms.entity.assist.CmsComment comment;
	 ...
	 */
	public com.cockroach.cockcms.cms.entity.assist.CmsComment getComment () {
		return comment;
	}
	 ...
	 */
	public void setComment (com.cockroach.cockcms.cms.entity.assist.CmsComment comment) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.cms.entity.assist.CmsCommentExt)) return false;
		else {
			com.cockroach.cockcms.cms.entity.assist.CmsCommentExt cmsCommentExt = (com.cockroach.cockcms.cms.entity.assist.CmsCommentExt) obj;
