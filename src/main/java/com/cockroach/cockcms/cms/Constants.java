package com.cockroach.cockcms.cms;
...
public class Constants {
     ...
     * 资源路径
     */
    public static final String RES_PATH = "/res/cms";
    /**
     * 模板路径
     */
    public static final String TPL_BASE = "/WEB-INF/tmpl/cms";
    /**
     * 全文检索索引路径
     */
     ...
     * 列表样式模板路径
     */
    public static final String TPL_STYLE_LIST = "/WEB-INF/tmpl/cms_sys_defined/style_list/style_";
    /**
     * 内容分页模板路径
     */
    public static final String TPL_STYLE_PAGE_CONTENT = "/WEB-INF/tmpl/cms_sys_defined/style_page/content_";
    /**
     * 列表分页模板路径
     */
    public static final String TPL_STYLE_PAGE_CHANNEL = "/WEB-INF/tmpl/cms_sys_defined/style_page/channel_";
    /**
     * 页面禁止访问
     */
     ...
     * 防火墙配置文件
     */
    public static String FIREWALL_CONFIG_PATH = "classpath:config/common/firewall.properties";
    /**
     * 类--错误国际化信息配置
     */
    public static String CLASS_ERROR_CODE = "classpath:config/common/classes-error.properties";
    /**
     * 配置文件
     */
    public static String CMS_CONFIG = "classpath:config/cms/cms.properties";
    /**
     * 插件路径
     */
    public static final String PLUGIN_PATH = "classpath:/config/plugin/";
    /**
     * 标签模板路径
     */
     ...
     * 模板路径
     */
    public static final String TPL_BACK_BASE = "/WEB-INF/admin";
}
