...
import com.cockroach.cockcms.cms.dao.main.ChannelDao;
...
import com.cockroach.cockcms.cms.manager.main.ChannelCountMng;
import com.cockroach.cockcms.cms.manager.main.ChannelExtMng;
import com.cockroach.cockcms.cms.manager.main.ChannelMng;
import com.cockroach.cockcms.cms.manager.main.ChannelTxtMng;
...
public class ChannelMngImpl implements ChannelMng {
	...
	@Transactional(readOnly = true)
	public List<Channel> getTopListByRight(Integer userId, Integer siteId,
