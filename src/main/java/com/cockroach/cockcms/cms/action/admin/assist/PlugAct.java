...
import com.cockroach.cockcms.cms.manager.assist.CmsPlugMng;
...
public class PlugAct {
    ...
    public String uploadSubmit(
        ...
        try {
            String fileUrl;
            String filename = Constants.PLUGIN_PATH + file.getOriginalFilename();
    ...
    private WebErrors validateUpload(MultipartFile file,
        ...
        String filePath = Constants.PLUGIN_PATH + filename;
