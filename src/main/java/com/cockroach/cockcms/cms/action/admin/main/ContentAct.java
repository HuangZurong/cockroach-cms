...
import com.cockroach.cockcms.cms.entity.main.CmsTopic;
...
import com.cockroach.cockcms.cms.entity.main.ContentType;
import com.cockroach.cockcms.cms.entity.main.Content.ContentStatus;
import com.cockroach.cockcms.cms.manager.assist.CmsFileMng;
import com.cockroach.cockcms.cms.manager.main.ChannelMng;
import com.cockroach.cockcms.cms.manager.main.CmsModelItemMng;
import com.cockroach.cockcms.cms.manager.main.CmsModelMng;
import com.cockroach.cockcms.cms.manager.main.CmsTopicMng;
import com.cockroach.cockcms.cms.manager.main.ContentMng;
import com.cockroach.cockcms.cms.manager.main.ContentTypeMng;
import com.cockroach.cockcms.cms.service.ImageSvc;
import com.cockroach.cockcms.cms.service.WeiXinSvc;
import com.cockroach.cockcms.cms.staticpage.exception.ContentNotCheckedException;
import com.cockroach.cockcms.cms.staticpage.exception.GeneratedZeroStaticPageException;
import com.cockroach.cockcms.cms.staticpage.exception.StaticPageNotOpenException;
import com.cockroach.cockcms.cms.staticpage.exception.TemplateNotFoundException;
import com.cockroach.cockcms.cms.staticpage.exception.TemplateParseException;
import com.cockroach.cockcms.common.image.ImageUtils;
import com.cockroach.cockcms.common.page.Pagination;
import com.cockroach.cockcms.common.upload.FileRepository;
...
import com.cockroach.cockcms.common.web.ResponseUtils;
...
import com.cockroach.cockcms.core.manager.CmsGroupMng;
...
import com.cockroach.cockcms.core.manager.DbFileMng;
import com.cockroach.cockcms.core.tpl.TplManager;
import com.cockroach.cockcms.core.web.WebErrors;
import com.cockroach.cockcms.core.web.util.CmsUtils;
import com.cockroach.cockcms.core.web.util.CoreUtils;
...
public class ContentAct{
	...
	public String tree(String root, HttpServletRequest request,
		...
		List<Channel> list;
		if (isRoot) {
			list = channelMng.getTopListByRight(userId, siteId, true);
		} else {
	...
	public String add(Integer cid,Integer modelId, HttpServletRequest request, ModelMap model) {
		...
		if (c != null) {
			...
			List<Channel> topList = channelMng.getTopListByRight(userId, siteId, true);
