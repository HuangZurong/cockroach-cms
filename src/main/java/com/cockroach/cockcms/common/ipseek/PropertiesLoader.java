package com.cockroach.cockcms.common.ipseek;
...
public class PropertiesLoader {
    ...
    static {
        ...
        InputStream in = PropertiesLoader.class.getResourceAsStream(API_FILENAME);
        ...
        if (in == null) {
            ...
            try {
                ...
                throw new RuntimeException("Error while processing " + API_FILENAME, e);
            }
        }
    }
