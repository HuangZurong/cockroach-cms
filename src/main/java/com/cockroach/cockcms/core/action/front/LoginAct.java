package com.cockroach.cockcms.core.action.front;

import static com.cockroach.cockcms.core.manager.AuthenticationMng.AUTH_KEY;
...
import com.cockroach.cockcms.common.security.BadCredentialsException;
import com.cockroach.cockcms.common.security.UsernameNotFoundException;
import com.cockroach.cockcms.common.web.RequestUtils;
import com.cockroach.cockcms.common.web.session.SessionProvider;
import com.cockroach.cockcms.core.entity.Authentication;
import com.cockroach.cockcms.core.manager.AuthenticationMng;
import com.cockroach.cockcms.core.web.WebCoreErrors;
...
public class LoginAct {
     ...
     * <li>统一登录。其他系统使用该入口统一登录。使用此功能processUrl不能为空。</li>
     * <li>单点登录。多系统通过该入口实现单点登录。如果session中AUTH_KEY存在，则直接重定向至processUrl。</li>
     * </ul>
     *
     ...
     * @param request
     * @param model
     * @return 重定向至processUrl，如processUrl不存在，则返回登录成功界面。
     */
