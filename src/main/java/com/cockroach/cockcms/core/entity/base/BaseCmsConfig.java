...
public abstract class BaseCmsConfig  implements Serializable {
	...
	// components
	 com.cockroach.cockcms.core.entity.MarkConfig m_markConfig;
	 com.cockroach.cockcms.core.entity.EmailConfig m_emailConfig;
	...
	public com.cockroach.cockcms.core.entity.MarkConfig getMarkConfig () {
		return m_markConfig;
	}
	 ...
	 */
	public void setMarkConfig (com.cockroach.cockcms.core.entity.MarkConfig m_markConfig) {
		this.m_markConfig = m_markConfig;
	}


	public com.cockroach.cockcms.core.entity.EmailConfig getEmailConfig () {
	 ...
	 */
	public void setEmailConfig (com.cockroach.cockcms.core.entity.EmailConfig m_emailConfig) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.core.entity.CmsConfig)) return false;
		else {
			com.cockroach.cockcms.core.entity.CmsConfig cmsConfig = (com.cockroach.cockcms.core.entity.CmsConfig) obj;
