...
public abstract class BaseConfig  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.core.entity.Config)) return false;
		else {
			com.cockroach.cockcms.core.entity.Config config = (com.cockroach.cockcms.core.entity.Config) obj;
