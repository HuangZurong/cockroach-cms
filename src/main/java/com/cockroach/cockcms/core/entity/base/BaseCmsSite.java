...
public abstract class BaseCmsSite  implements Serializable {
	...
	// many to one
	private com.cockroach.cockcms.core.entity.Ftp uploadFtp;
	private com.cockroach.cockcms.core.entity.CmsConfig config;
	// one to one
	private com.cockroach.cockcms.core.entity.CmsSiteCompany siteCompany;
	 ...
	 */
	public com.cockroach.cockcms.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (com.cockroach.cockcms.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.cockroach.cockcms.core.entity.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.cockroach.cockcms.core.entity.CmsConfig config) {
		this.config = config;
	}
	
	public com.cockroach.cockcms.core.entity.CmsSiteCompany getSiteCompany() {
		return siteCompany;
	}

	public void setSiteCompany(com.cockroach.cockcms.core.entity.CmsSiteCompany siteCompany) {
	...
	public void setUserSites(
			java.util.Set<com.cockroach.cockcms.core.entity.CmsUserSite> userSites) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.core.entity.CmsSite)) return false;
		else {
			com.cockroach.cockcms.core.entity.CmsSite cmsSite = (com.cockroach.cockcms.core.entity.CmsSite) obj;
