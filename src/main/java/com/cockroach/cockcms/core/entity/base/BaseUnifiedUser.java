...
public abstract class BaseUnifiedUser  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.core.entity.UnifiedUser)) return false;
		else {
			com.cockroach.cockcms.core.entity.UnifiedUser unifiedUser = (com.cockroach.cockcms.core.entity.UnifiedUser) obj;
