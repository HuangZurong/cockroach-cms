...
public abstract class BaseCmsUserSite  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.core.entity.CmsUserSite)) return false;
		else {
			com.cockroach.cockcms.core.entity.CmsUserSite cmsUserSite = (com.cockroach.cockcms.core.entity.CmsUserSite) obj;
