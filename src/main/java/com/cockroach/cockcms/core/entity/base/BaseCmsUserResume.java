...
public abstract class BaseCmsUserResume  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.core.entity.CmsUserResume)) return false;
		else {
			com.cockroach.cockcms.core.entity.CmsUserResume cmsUserResume = (com.cockroach.cockcms.core.entity.CmsUserResume) obj;
