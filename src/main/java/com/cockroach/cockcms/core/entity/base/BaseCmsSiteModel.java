...
public abstract class BaseCmsSiteModel  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.core.entity.CmsSiteModel)) return false;
		else {
			com.cockroach.cockcms.core.entity.CmsSiteModel cmsSiteModel = (com.cockroach.cockcms.core.entity.CmsSiteModel) obj;
