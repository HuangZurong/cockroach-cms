...
public abstract class BaseFtp  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.core.entity.Ftp)) return false;
		else {
			com.cockroach.cockcms.core.entity.Ftp ftp = (com.cockroach.cockcms.core.entity.Ftp) obj;
