...
public abstract class BaseCmsUserExt  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.core.entity.CmsUserExt)) return false;
		else {
			com.cockroach.cockcms.core.entity.CmsUserExt cmsUserExt = (com.cockroach.cockcms.core.entity.CmsUserExt) obj;
