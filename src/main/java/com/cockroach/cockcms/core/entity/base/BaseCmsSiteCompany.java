...
public abstract class BaseCmsSiteCompany  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.cockroach.cockcms.core.entity.CmsSiteCompany)) return false;
		else {
			com.cockroach.cockcms.core.entity.CmsSiteCompany cmsSiteCompany = (com.cockroach.cockcms.core.entity.CmsSiteCompany) obj;
